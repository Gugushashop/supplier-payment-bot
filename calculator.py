...
def calculate_daily_totals() -> str:
    ...
    if not suppliers:
        return "❌ Нет добавленных поставщиков"
    ...
    summary_lines.append("")
    summary_lines.append("📊 <i>Сводка сформирована автоматически в 17:00</i>")
...
def format_supplier_summary(
    ...
    if minuses_uah > 0 or minuses_usd > 0:
        if minuses_uds > 0 and minuses_uah > 0:
    ...
    # Итого
    if total_uds > 0 and total_uah > 0:
